...
import numpy as np
from model import ScheduledOptim, FastSpeech2Loss, FastSpeech2_IIV, FastSpeech2_GST
import yaml


def test_fastspeech2_GST():
    ...
    model_config = config_dir + "/model_fastspeechSeqstyle.yaml"
    model_config = config_dir + "/model_fastspeechGst.yaml"
    ...
    model = FastSpeech2_GST(preprocess_config, model_config)
